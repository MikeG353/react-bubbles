...
- [x] Explain what a token is used for.
  ...
  A token can be used to authenticate a user. It is stored in the browsers local storage and can be passed to a server as an authetication method.

- [x] What steps can you take in your web apps to keep your data secure?

  keeping private routes behind an authentication check can help. Never keep passwords stored in plain text etc.
